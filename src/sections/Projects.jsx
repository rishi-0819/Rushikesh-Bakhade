...
const projects = [
   {
    ...
    link: "https://flyandtech.com/",
    github: "#"
   },
    {
    title:"Concept Tutorials",
    description:"A comprehensive online learning platform with interactive courses, quizzes and projects for tech enthusiasts",
    image :"/projects/dash1.png.png",
    tags : ["React", "TypeScript", "Node.js", "MongoDB"],
    link: "https://concepttutorials.co.in/",
    github: "#"
   },
    {
    title:"Concreteman website",
    description:"Concrete man website for showing the precast wall and the precast materialistics in industry standard way",
    image :"/projects/dash2.png.png",
    tags : ["React", "TypeScript", "Node.js", "MongoDB"],
    link: "https://concreteman.co.in/",
    github: "#"
   },
]
...
export const Projects = () => {
  return <section 
      id="projects" className="py-32 relative overflow-hidden">
        {/*bg blowa */}
            ...
            {projects.map((project,idx) => (
              <div key={idx} className="group glass rounded-2xl overflow-hidden animate-fade-in md:row-span-1" 
                ...
                <div className="p-6 space-y-4"> 
                  ...
                  <p className="text-muted-foregound text-sm">{project.description}</p>
